...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubIndicator.current_result'
        db.add_column(u'logframe_subindicator', 'current_result',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubIndicator.current_result'
        db.delete_column(u'logframe_subindicator', 'current_result')
    ...
    models = {
        ...
        u'logframe.milestone': {
            'Meta': {'ordering': "[u'id']", 'object_name': 'Milestone'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
