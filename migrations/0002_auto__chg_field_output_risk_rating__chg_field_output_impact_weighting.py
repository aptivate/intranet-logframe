...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Output.risk_rating'
        db.alter_column(u'logframe_output', 'risk_rating_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['logframe.RiskRating'], null=True))

        # Changing field 'Output.impact_weighting'
        db.alter_column(u'logframe_output', 'impact_weighting', self.gf('django.db.models.fields.SmallIntegerField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Output.risk_rating'
        raise RuntimeError("Cannot reverse this migration. 'Output.risk_rating' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Output.impact_weighting'
        raise RuntimeError("Cannot reverse this migration. 'Output.impact_weighting' and its values cannot be restored.")
