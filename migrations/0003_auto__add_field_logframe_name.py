...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LogFrame.name'
        db.add_column(u'logframe_logframe', 'name',
                      self.gf('django.db.models.fields.CharField')(default='logframe', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LogFrame.name'
        db.delete_column(u'logframe_logframe', 'name')
